...
export default function NotFound() {
  return (
    <div style={{ backgroundColor: "var(--sw-bg)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <Navigation />
      <main className="flex-1 flex items-center justify-center px-4" style={{ paddingTop: "80px", paddingBottom: "80px" }}>
        <div className="text-center max-w-lg mx-auto">
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "16px", color: "var(--sw-text-muted)", lineHeight: 1.7, marginBottom: "32px" }}>
