      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.25fr] gap-8 lg:gap-5 items-stretch">
              ...
              <div className="flex flex-col justify-center">
                ...
                >
                  We build <strong style={{ color: COLORS.text }}>Conversion &amp; Credibility Systems</strong> — not
                  just websites — for Nigerian clinics, coaches, and e-commerce brands. Your
                  next client is already searching. Make sure they stay.
                </p>
        ...
        <Section>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center">
              <WhatsAppCTA>Request a Free Audit &amp; Find Out Why</WhatsAppCTA>
            </div>
          </div>
        </Section>
        ...
        <Section id="how-it-works">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* CTA */}
            <div className="text-center">
              <WhatsAppCTA>Start With a Free Audit</WhatsAppCTA>
            </div>
          </div>
        </Section>
