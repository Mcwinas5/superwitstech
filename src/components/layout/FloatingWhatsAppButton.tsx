...
export default function FloatingWhatsAppButton() {
  ...
  return (
    <div style={{ position: "fixed", bottom: "24px", right: "24px", zIndex: 100, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "8px" }}>
      {hovered && (
        <div style={{ backgroundColor: "#0F1F3D", border: "1px solid #1A3260", borderRadius: "6px", padding: "8px 14px", fontFamily: "'Inter', sans-serif", fontSize: "13px", fontWeight: 500, color: "#F1F5F9", whiteSpace: "nowrap", boxShadow: "0 4px 16px rgba(0,0,0,0.4)", animation: "fadeInUp 0.15s ease" }}>
          Chat on WhatsApp
        </div>
      )}
