        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", color: "#94A3B8", marginBottom: "16px", lineHeight: 1.6 }}>3 free audit slots available this week.</p>
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="hover:bg-amber-500 transition-colors block text-center" style={{ width: "100%", padding: "12px 24px", borderRadius: "6px", fontFamily: "'Inter', sans-serif", fontSize: "14px", fontWeight: 600, backgroundColor: "#D97706", color: "#FFFFFF", textDecoration: "none", minHeight: "44px", lineHeight: "20px" }}>
